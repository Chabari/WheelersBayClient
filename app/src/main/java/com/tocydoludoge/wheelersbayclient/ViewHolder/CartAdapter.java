...
public class CartAdapter extends RecyclerView.Adapter<CartViewHolder>{
    ...
    private List<Hire> listData = new ArrayList<>();
    private Context context;

    public CartAdapter(List<Hire> listData, Context context){
    ...
    public void onBindViewHolder(CartViewHolder holder, int position) {
        TextDrawable drawable = TextDrawable.builder().buildRound(""+listData.get(position).getDuration(), Color.RED);
        holder.img_cart_count.setImageDrawable(drawable);

        Locale locale = new Locale("en","US");
        NumberFormat fmt = NumberFormat.getCurrencyInstance(locale);
        int price = (Integer.parseInt(listData.get(position).getRate()))*(Integer.parseInt(listData.get(position).getDuration()));
